        ...
        <div className="second">
          <div class="row mb-3">
            <div class="col-sm-6 mb-3 mb-sm-0">
              <div class="card people " onMouseEnter={()=>setIsHover(true)} onMouseLeave={()=>setIsHover(false)} style={isHover ? {backgroundColor:"#8064A2",color:"white" } : {} } >
                <div class="card-body  ">
            ...
            <div class="col-sm-6">
              <div class="card place " onMouseEnter={()=>setIsHover1(true)} onMouseLeave={()=>setIsHover1(false)} style={isHover1 ? {backgroundColor:"#77933C",color:"white" } : {} }  >
                <div class="card-body">
                  <h5 class="card-title text-size">
                    <span>
                      <svg
          ...
          <div class="row mt-3 ">
            <div class="col-sm-6 mb-3 mb-sm-0">
              <div class="card product " onMouseEnter={()=>setIsHover2(true)} onMouseLeave={()=>setIsHover2(false)} style={isHover2 ? {backgroundColor:"#C0504D",color:"white" } : {} }>
                <div class="card-body">
                  <h5 class="card-title text-size">
                    <span>
                      <svg
            ...
            <div class="col-sm-6">
              <div class="card program" onMouseEnter={()=>setIsHover3(true)} onMouseLeave={()=>setIsHover3(false)} style={isHover3 ? {backgroundColor:"#0096C8",color:"white" } : {} } >
                <div class="card-body">
                  <h5 class="card-title text-size">
                    <span>
                      <svg
